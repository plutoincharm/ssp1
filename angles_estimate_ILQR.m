...
while iteration <counter
    ...
    theta_HAT(i) = atan2(xiphoid_z(i) -cord(i,7),xiphoid_x(i)-cord(i,6));
    theta_l_thigh(i) = pi +  atan2(cord(i,7)-cord(i,3),cord(i,6)-cord(i,2));
    theta_l_leg(i) = pi + atan2(cord(i,11)-cord(i,7),cord(i,10)-cord(i,6));
    theta_r_thigh(i) = pi + atan2(cord(i,9)-cord(i,5),cord(i,8)-cord(i,4));
    theta_r_leg(i) = pi + atan2(cord(i,13)-cord(i,9),cord(i,12)-cord(i,8));
    ...
    theta_r_ankle(i) =  atan2(cord(i,13)-rpost_z(i),cord(i,12)-rpost_x(i));
        ...
        if cord(i,1) == 0
           x0(:,1) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100];
         

        elseif cord(i,1) == 0.05
           x0(:,2) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100] ;  
       
        elseif cord(i,1)==0.25
        x0(:,3) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100] ;
         
        elseif cord(i,1)==0.54
             x0(:,4) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100] ;
        elseif cord(i,1)==0.75
             x0(:,5) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100] ;
        elseif cord(i,1)==1
             x0(:,6) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100] ;    
        elseif cord(i,1)==1.24
             x0(:,7) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100] ;
        elseif cord(i,1)==1.39
             x0(:,8) = [ theta_HAT(i); theta_l_thigh(i);theta_l_leg(i);theta_l_ankle(i);theta_r_thigh(i);theta_r_leg(i);theta_r_ankle(i);xiphoid_x(i)/100;xiphoid_z(i)/100] ;
